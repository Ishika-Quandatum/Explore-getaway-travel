...
const Blog = ({ blogs, onViewAllBlogs, onSelectBlog }) => {
  ...
  return (
    <section id="blog-section" className="scroll-mt-28 py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          ...
          <button
            ...
            className="flex items-center gap-2 text-xs font-semibold text-slate-900 uppercase tracking-wider hover:text-amber-500 transition-colors group cursor-pointer relative z-20"
          >
            VIEW ALL BLOGS
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {displayBlogs.map((blog) => (
            <div
              ...
              className="group flex flex-col cursor-pointer bg-white rounded-sm overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300"
            >
              {/* Image */}
